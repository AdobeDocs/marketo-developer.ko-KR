...
자세한 내용은 제품 설명서에서 [인앱 메시지](https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/mobile-marketing/in-app-messages/creating-in-app-messages/create-an-in-app-message)를 참조하세요.
