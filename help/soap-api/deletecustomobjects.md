...
하나 이상의 사용자 지정 개체를 삭제하고 작업 결과(DELETED, UNCHANGED, FAILED)를 반환합니다.
...
| customObjKeyLists->keyList->attribute | 필수 | 속성은 삭제할 사용자 지정 개체를 식별하는 데 사용되는 키/값 쌍입니다. customObjKeyLists에서 여러 속성을 지정할 수 있습니다 |
