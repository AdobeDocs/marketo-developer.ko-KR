...
feature: SOAP
description: Marketo SOAP getCampaignsForSource는 requestCampaign에 대해 소스별로 적합한 스마트 캠페인을 반환하며, Campaign이 요청된 트리거, XML 및 PHP 예제가 필요합니다.
...
이 함수는 requestCampaign 함수의 입력 매개 변수로 사용할 수 있는 적격한 Marketo 캠페인 목록을 반환합니다. 캠페인은 WSDL에서 계산되는 요청의 소스로 분류됩니다.

중요: 스마트 캠페인에 자격을 부여하려면 &quot;캠페인이 요청됨&quot; 트리거가 있어야 합니다. 소스에는 웹 서비스 API가 포함되어야 합니다.
