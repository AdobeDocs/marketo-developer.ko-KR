...
Marketo Engage SOAP API는 2025년 10월 31일 이후 중단됩니다. SOAP API를 사용하는 기존의 모든 통합은 서비스가 중단되지 않도록 하려면 이 날짜까지 [Marketo Engage REST API](https://experienceleague.adobe.com/en/docs/marketo-developer/marketo/rest/rest-api)(으)로 중단되거나 마이그레이션되어야 합니다.
...
2. 일부 Marketing Assets의 구성과 [Forms API](https://experienceleague.adobe.com/en/docs/marketo-developer/marketo/rest/assets/forms)와의 상호 작용이 필요하지만 [양식 제출](https://experienceleague.adobe.com/en/docs/marketo-developer/marketo/rest/lead-database/leads&quot;%20\l%20&quot;submit-form)을 호출할 수 있습니다
...
- [스마트 캠페인](https://experienceleague.adobe.com/en/docs/marketo-developer/marketo/rest/assets/smart-campaigns&quot;%20\h%20HYPERLINK%20&quot;https://experienceleague.adobe.com/en/docs/marketo-developer/marketo/rest/assets/smart-campaigns)
...
- [사용자 지정 개체](https://experienceleague.adobe.com/en/docs/marketo-developer/marketo/rest/lead-database/custom-objects&quot;%20\h%20HYPERLINK%20&quot;https://experienceleague.adobe.com/en/docs/marketo-developer/marketo/rest/lead-database/custom-objects)
