...
랜딩 페이지에 Munchkin 베타 채널을 옵트인하려면 [관리자 -> 보물 상자](https://experienceleague.adobe.com/ko/docs/marketo/using/product-docs/administration/settings/enable-or-disable-treasure-chest-features) 메뉴로 이동하여 &quot;랜딩 페이지에 Munchkin Beta&quot; 설정을 활성화하십시오. 외부 사이트에서 Beta 버전을 사용할 수 있도록 **[!UICONTROL Admin]** -> **[!UICONTROL Munchkin]** 메뉴에 새로운 코드 조각을 제공합니다.
