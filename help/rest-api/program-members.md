...
GET 요청의 총 길이가 8KB를 초과하는 경우 HTTP 오류가 반환됩니다. &quot;[RFC 7231](https://datatracker.ietf.org/doc/html/rfc72316.5.12)에 따라 URI가 너무 깁니다.&quot; 해결 방법으로, GET을 POST으로 변경하고, `_method=GET` 매개 변수를 추가하고, 요청 본문에 쿼리 문자열을 배치할 수 있습니다.
