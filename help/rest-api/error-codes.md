...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>요청의 URI가 8k를 초과했습니다. 요청을 URL에 매개 변수 `_method=GET'가 있는 POST으로 다시 시도하고 요청 본문에 나머지 쿼리 문자열을 사용해야 합니다.</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Salesforce Person 계정인 가망 고객을 병합하려는 시도로 인해 가망 고객 병합 호출이 실패했습니다.  Salesforce 개인 계정은 Salesforce에서 병합해야 합니다.</td>
    </tr>
    <tr>
