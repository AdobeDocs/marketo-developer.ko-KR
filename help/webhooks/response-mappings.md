...
응답 매핑의 `foo` 속성에 액세스하려면 속성의 `name`을(를) 사용하십시오. 이 속성은 JSON 개체의 첫 번째 수준인 `foo`에 있기 때문입니다. 다음은 Marketo의 모습을 보여 줍니다.
...
XML 문서의 개별 요소에서 값에 액세스할 수 있습니다. JSON 매핑과 유사한 점 표기법을 사용합니다. 이 간단한 예를 생각해 보십시오.
